...
from nanochat.common import compute_init, compute_cleanup, print0, get_base_dir, get_logger, autodetect_device_type
...
# wandb logging init
wandb_run = get_logger("nanochat-rl", args.run, user_config, master_process)
